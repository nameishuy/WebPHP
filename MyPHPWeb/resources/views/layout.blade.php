...
<body>
        ...
        <div class="container-fluid justify-content-around align-items-center">
            ...
            @else
                <div class="Account__Area align-items-center" id="Account_Area">
                    <a class="text-decoration-none link-dark border border-dark rounded-1 pe-3 ps-3 pt-1 pb-1"
                        id="SignIn" href="/signin">Đăng Nhập</a>
                    <a class="text-decoration-none link-light bg-dark border border-dark rounded-1 pe-3 ps-3 pt-1 pb-1"
    ...
    <script src="js/cart.js"></script>z
