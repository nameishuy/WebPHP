                            ...
                            <div class="Cart__Products-group-product-info">
                                <div class="Cart__Products-Count">
                                    <div class="Cart__Products-Button">
                                        <a onclick="lessProducts()" href="/minusCountItem?id=<?php echo $item['id']; ?>">
                                        ...
                                        <input id="inputNum" type="text" value="<?php echo $item['count']; ?>"
                                            placeholder="<?php echo $item['count']; ?>" class="input" name="cartInput">
                                        <a onclick="moreProducts()" href="/plusCountItem?id=<?php echo $item['id']; ?>">
                                ...
                                <a class="btnDeleteItem" href="/cart?deleteid=<?php echo $item['id']; ?>">
